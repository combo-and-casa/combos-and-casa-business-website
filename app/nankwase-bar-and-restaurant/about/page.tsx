...
import { restaurantServices } from "@/utils/constents";
...
export default function RestaurantAbout() {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        const response = await fetch('/api/restuarant/upcoming-events');
  ...
  const galleryImages = [
    "/pasta-2.jpg",
    "/hands-holding-drink.png",
    "/fries-and-chicken-2.jpg",
    "/hands-in-food.png",
    "/vip-dining.jpeg",
    "/nankwase-front-view-day.jpg"
  ];
    ...
    <div className="min-h-screen bg-[#0A0A0A] pt-20">
      ...
      <section className="relative py-20 md:py-32 px-6 lg:px-8 overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: "url('/jollof-in-hand.jpeg')" }}
        />
                ...
                >
                  <div className="flex items-center gap-6">
                    <div className="w-24 h-24 rounded-xl gradient-gold flex items-center justify-center flex-col shrink-0">
                      <span className="text-black font-bold text-2xl">{formatEventDate(event.event_date).split(' ')[1]}</span>
                      <span className="text-black text-sm font-semibold">{formatEventDate(event.event_date).split(' ')[0]}</span>
                    </div>
            ...
            >
              ...
              <div className="space-y-3 text-white/70">
                ...
                <div className="pt-4 border-t border-white/10">
                  <p className="text-sm text-[#D4AF37]">* Live Band: Fridays 7:00 PM - 10:00 PM</p>
                </div>
              </div>
            </motion.div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/60"><a href="tel:+233509251268">+233 509 251 268</a></p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/60"><a href="mailto:info@combosandcasagh.com">info@combosandcasagh.com</a></p>
                  </div>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-20 px-6 lg:px-8 relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('/nankwase-front-view.jpg')] bg-cover bg-center opacity-30" />
